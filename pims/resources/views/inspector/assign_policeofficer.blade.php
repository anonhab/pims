    ...
    <div class="pims-assignment-card">
        ...
        <div class="pims-assignment-body">
            ...
            <div class="pims-assignment-detail">
                ...
                {{ optional($assignment->officer)->first_name ?? 'Not assigned' }}
            </div>
        ...
        <div class="pims-assignment-footer">
            <button class="pims-footer-btn edit" onclick="pimsOpenEditForm({{ $assignment->assignment_id }})">
                Edit
            </button>
...
@endforeach
    ...
    <div id="pims-assignment-form" class="pims-modal">
        <div class="pims-modal-card">
            ...
            <form action="{{ route('assign_officer') }}" method="POST">
                @csrf
                <section class="pims-modal-body">
                    ...
                    <!-- Select officers -->
                    <div class="pims-form-group">
                        <label class="pims-form-label">officers</label>
                        <select class="pims-form-select" name="officer_id" required>
                            <option value="">Select officers</option>
                            @foreach($officers as $officers)
                                <option value="{{ $officers->user_id }}">{{ $officers->first_name }} {{ $officers->last_name }}</option>
                            @endforeach
                        </select>
                    </div>

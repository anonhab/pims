...
<head>
    ...
    <style>
        :root {
            --pims-primary: #1a2a3a; /* Darker blue for more authority */
            --pims-secondary: #2c3e50;
            --pims-accent: #2980b9; /* Slightly darker blue */
            --pims-danger: #c0392b; /* Darker red */
            --pims-success: #27ae60; /* Darker green */
            --pims-warning: #d35400; /* Darker orange */

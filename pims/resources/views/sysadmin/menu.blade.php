        ...
        <aside class="sidebar-menu flex-1 overflow-y-auto">
            <ul class="sidebar-menu-list space-y-2 p-4">
                ...
                <li class="sidebar-menu-item">
                    <a href="/sysdashboard" class="sidebar-menu-link flex items-center p-3 rounded-lg text-gray-200 hover:text-white transition-all duration-200">
                ...
                <li class="sidebar-menu-item sidebar-has-submenu">
                    ...
                    <ul class="sidebar-submenu pl-6 space-y-2">
                        <li class="sidebar-submenu-item">
                            <a  href="{{ route('saccount.add') }}"  class="sidebar-submenu-link text-gray-300 hover:text-white text-sm p-2 block">Create Account</a>
                        </li>
                        <li class="sidebar-submenu-item">
                            <a href="{{ route('saccount.show_all') }}"  class="sidebar-submenu-link text-gray-300 hover:text-white text-sm p-2 block">View Account Details</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-has-submenu">
                    ...
                    <ul class="sidebar-submenu pl-6 space-y-2">
                        <li class="sidebar-submenu-item">
                            <a href="/sysadmin/generate_report" class="sidebar-submenu-link text-gray-300 hover:text-white text-sm p-2 block">Generate Report</a>
                        </li>
                        <li class="sidebar-submenu-item">
                            <a href="/sysadmin/view_reports"  class="sidebar-submenu-link text-gray-300 hover:text-white text-sm p-2 block">View Generated Reports</a>
                        </li>
                    </ul>
                </li>
            </ul>

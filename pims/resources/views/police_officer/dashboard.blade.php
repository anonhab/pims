...
<head>
    ...
    <title>PIMS - Police Dashboard</title>
...
<body>
    ...
    <div id="pims-page-content">
        <h1 class="pims-section-title">
            <i class="fas fa-user-shield"></i> Police Officer Dashboard
        </h1>
        ...
        <div class="pims-stats-box">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                <h2><i class="fas fa-user-lock"></i> Your Assigned Prisoners</h2>
                <div style="display: flex; gap: 1rem;">
                    <div class="pims-search-box">
                        <i class="fas fa-search"></i>
                        <input type="text" id="pims-prisoner-search" placeholder="Search prisoners...">
                    </div>
                    <button class="pims-btn pims-btn-primary" id="pims-prisoner-reload">
        ...
        <div class="pims-stats-box">
            <h2><i class="fas fa-chart-bar"></i> Prisoner Room Allocation</h2>
            <canvas id="roomAllocationChart" height="100"></canvas>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Search functionality for assigned prisoners
            const prisonerSearchInput = document.getElementById('pims-prisoner-search');
            const prisonerItems = document.querySelectorAll('.pims-stats-box ul li');

            prisonerSearchInput.addEventListener('input', function() {
                const filter = prisonerSearchInput.value.toLowerCase();
                prisonerItems.forEach(item => {
            ...
            // Reload button
            document.getElementById('pims-prisoner-reload').addEventListener('click', () => {
                window.location.reload();
            });

            // Initialize room allocation chart
            const ctx = document.getElementById('roomAllocationChart').getContext('2d');
            new Chart(ctx, {
                type: 'bar',
                data: {

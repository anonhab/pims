...
<head>
    ...
    <div id="touchMenu">
        ...
        <a class="navbar-item is-active" href="elements.html">
            <span class="icon">
    ...
    <aside class="menu">
        ...
        <ul class="menu-list">
            ...
            <li>
                <a class="is-active" href="elements.html">
                    <span class="icon">
                        <i class="fa fa-desktop"></i>
                    </span> UI Elements
                </a>
...
<!-- Mirrored from bulma-admin.test/elements by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Feb 2024 10:20:26 GMT -->
</html>

...
<script>
 document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('#pimsSidebar2 .pims-has-submenu > .pims-menu-link').forEach(link => {
        link.addEventListener('click', function(e) {
            if (window.innerWidth > 1024 || !document.getElementById('pimsSidebar2').classList.contains('pims-collapsed')) {
                e.preventDefault();
    ...
    // Mobile sidebar toggle for second sidebar
    document.getElementById('pimsSidebarToggle2').addEventListener('click', function() {
        document.getElementById('pimsSidebar2').classList.toggle('pims-active');
    });

    // Close sidebar when clicking X for second sidebar
    document.getElementById('pimsCloseSidebar2').addEventListener('click', function(e) {
        e.stopPropagation();
        document.getElementById('pimsSidebar2').classList.remove('pims-active');
    });

    // Close sidebar when clicking outside on mobile for second sidebar
    document.addEventListener('click', function(e) {
        const sidebar = document.getElementById('pimsSidebar2');
        const toggleBtn = document.getElementById('pimsSidebarToggle2');
    ...
    // Toggle collapsed state on desktop for second sidebar
    document.getElementById('pimsCollapseBtn2').addEventListener('click', function() {
        document.getElementById('pimsSidebar2').classList.toggle('pims-collapsed');
    });

    // Mark active menu item based on current URL for second sidebar
    document.addEventListener('DOMContentLoaded', function() {
        const currentUrl = window.location.href;
        document.querySelectorAll('#pimsSidebar2 .pims-menu-link, #pimsSidebar2 .pims-submenu-link').forEach(link => {
    ...
    // Auto-collapse on smaller screens for second sidebar
    function checkScreenSize2() {
        if (window.innerWidth <= 1200 && window.innerWidth > 1024) {
            document.getElementById('pimsSidebar2').classList.add('pims-collapsed');
        } else if (window.innerWidth > 1200) {
            document.getElementById('pimsSidebar2').classList.remove('pims-collapsed');
        }
    }
